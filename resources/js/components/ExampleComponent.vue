    ...
    <div>
      ...
      <el-button type="danger" icon="el-icon-delete" circle></el-button>
        ...
        <el-steps :active="this.active">
            <el-step title="๑.ข้อมูลผู้ส่งเอกสาร" icon="el-icon-edit">
            </el-step>
            <el-step title="๒.เอกสารหลักฐาน" icon="el-icon-upload"></el-step>
            <el-step title="๓.ตรวจสอบข้อมูล" icon="el-icon-picture"></el-step>
        </el-steps>
          ...
          <el-option label="ธรรมศึกษา" value="2"></el-option>
            ...
            <div v-if="active===1">
                <el-form-item label="สำนักเรียน" prop="ss">
                    <model-list-select :list="datasnr" v-model="ruleForm.snr" option-value="id" v-on:input="selectsnr()" :custom-text="customdata2" placeholder="select item">
                    </model-list-select>
                    <!-- <el-input  v-model="ruleForm.ss" :maxlength="7" :minlength="7"></el-input> -->
                </el-form-item>
                <el-form-item label="รหัสสนามสอบ" prop="ss">
                    <model-list-select :list="datassfiter" v-model="ruleForm.ss" option-value="id" :isDisabled="show" v-on:input="selectss()" :maxlength="7" :custom-text="customdata" placeholder="select item">
                    </model-list-select>
                    <!-- <el-input  v-model="ruleForm.ss" :maxlength="7" :minlength="7"></el-input> -->
                </el-form-item>
...
<template>
  ...
  <div v-if="active===3">
    <b-card class="mt-3" header="ข้อมูลการส่งเอกสาร">
        ...
        data() {
            return {
                ...
                rules: {
                    fullname: [{
                            required: true,
                            message: 'กรุณากรอกชื่อผู้ส่งเอกสาร',
                            trigger: 'blur'
                        }
                    ...
                    ssr: [{
                            type: 'number',
                            required: true,
                            message: 'กรองเฉพาะตัวเลข-รหัสสนามสอบให้ถูกต้อง',
                            trigger: 'blur'
                        }
                    ...
                    position: [{
                            required: true,
                            message: 'กรุณากรอกตำแหน่ง หรือหน้าที่',
                            trigger: 'blur'
                        }
                        // { min: 6, max: 7, message: 'ใส่รหัสสนามสอบธรรมศึกษาและนักธรรม 6 ถึง 7 หลัก', trigger: 'blur' }
                    ],
                    phone: [{
                            required: true,
                            message: 'เบอร์โทรศัพท์สำหรับติดต่อกลับ',
                            trigger: 'blur'
                        }
                        // { min: 6, max: 7, message: 'ใส่รหัสสนามสอบธรรมศึกษาและนักธรรม 6 ถึง 7 หลัก', trigger: 'blur' }
                    ],
